// Central registry of SOPs. Add new SOPs here — everything else
// (routes, viewer pages, QR codes) is generated automatically from this list.

const sops = [
  {
    slug: "dos-donts",
    shortTitle: "Do's & Don'ts",
