    ...
    <div className="page">
      ...
      <main className="qr-page">
        <div className="qr-page__intro no-print">
          <span className="qr-page__eyebrow">Deployment</span>
          <h1>Printable QR Codes</h1>
          <p>
            Each code below links directly to that document's live URL.
            Print and affix to the corresponding instrument. Use the browser
            print function to print this page directly onto label stock.
          </p>
